...
| Issue | ID | タイトル | 状態 |
|-------|-----|----------|------|
| [#81](https://github.com/kuwa2005/PukiWiki2026/issues/81) | SEC-U01 | Unicode BiDi/RTL 制御文字によるページ名なりすまし | **open** |
...
| ID | 深刻度 | タイトル | 状態 | 備考 |
|----|--------|----------|------|------|
| SEC-U01 | High | ページ名の RTL override（U+202E）等 — 表示なりすまし | **open** | [#81](https://github.com/kuwa2005/PukiWiki2026/issues/81) |
| SEC-U02 | Medium | NFKC 未適用によるホモグリフ別ページ | **open** | |
| SEC-U03 | Medium | ユーザー名 BiDi/制御文字 | **open** | |
| SEC-U04 | Medium | 添付ファイル名 BiDi/制御文字 | **open** | |
