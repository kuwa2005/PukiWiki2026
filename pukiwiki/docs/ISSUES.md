...
| Issue | タイトル | 備考 |
|-------|----------|------|
| [#58](https://github.com/kuwa2005/PukiWiki2026/issues/58) | 公式同梱ファイルを pukiwiki/ へ集約 | PR merge 後に close |
...
| [#58](https://github.com/kuwa2005/PukiWiki2026/issues/58) | 公式同梱ファイルを pukiwiki/ へ集約 | **open** | （PR 作成予定） |
