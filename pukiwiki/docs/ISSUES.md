...
| Issue | タイトル | 備考 |
|-------|----------|------|
| [#83](https://github.com/kuwa2005/PukiWiki2026/issues/83) | 2026-06-07 セキュリティ再監査 — 手法・判断根拠 | PR #82 再監査の記録 |
...
| ID | 深刻度 | タイトル | 状態 | 備考 |
|----|--------|----------|------|------|
| SEC-U01 | High | ページ名の RTL override（U+202E）等 — 表示なりすまし | **fixed** | [#81](https://github.com/kuwa2005/PukiWiki2026/issues/81) / [#84](https://github.com/kuwa2005/PukiWiki2026/pull/84) |
